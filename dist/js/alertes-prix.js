/**
 * Système d'Alertes Prix - NesThai Property
...
(function() {
    ...
    // Configuration
    const CONFIG = {
        storageKey: 'nesthai_price_alerts',
        adminEmail: 'alertes@nesthai.com',
        maxAlertsPerEmail: 5,
        cookieExpiry: 365
    };
    ...
    function saveAlert(formData) {
        ...
        setCookie('nesthai_alert_email', alert.email, CONFIG.cookieExpiry);
