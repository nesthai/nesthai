// ============================================
// BEAULIEU REAL ESTATE - JAVASCRIPT COMPLET
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('✅ Beaulieu website loaded successfully');
});
...
function changeLang(lang) {
    ...
    localStorage.setItem('beaulieu-lang', lang);
...
document.addEventListener('DOMContentLoaded', () => {
    const savedLang = localStorage.getItem('beaulieu-lang') || 'fr';
...
// ============================================
// BEAULIEU PROPERTY MANAGEMENT - MAIN JS
// ============================================
